...
import { EPermission, UserUtils, UserSession } from '../security';
...
function PermissionsEntry({ permission, setPermission, setGetter, }) {
    ...
    return (React.createElement("div", { className: "btn-group col-sm-auto", role: "group" },
        ...
        React.createElement("label", { htmlFor: `btnradio_permissions_${id}_none`, className: "form-label btn btn-outline-secondary btn-sm" },
            ...
            " ",
            I18nextManager.getInstance().i18n.t('visyn:permission.noPermission')),
        ...
        React.createElement("label", { htmlFor: `btnradio_permissions_${id}_read`, className: "form-label btn btn-outline-secondary btn-sm" },
            ...
            " ",
            I18nextManager.getInstance().i18n.t('visyn:permission.read')),
        ...
        React.createElement("label", { htmlFor: `btnradio_permissions_${id}_write`, className: "form-label btn btn-outline-secondary btn-sm" },
            ...
            " ",
            I18nextManager.getInstance().i18n.t('visyn:permission.write'))));
}
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "form-check form-check-inline" },
            ...
            React.createElement("label", { className: "form-label form-check-label", htmlFor: `global_permission_private_${id}` },
                ...
                " ",
                I18nextManager.getInstance().i18n.t('visyn:permission.private'))),
        React.createElement("div", { className: "form-check form-check-inline" },
            ...
            React.createElement("label", { className: "form-label form-check-label", htmlFor: `global_permission_public_${id}` },
                ...
                " ",
                I18nextManager.getInstance().i18n.t('visyn:permission.publicMsg'))),
        React.createElement("button", { type: "button", name: "permission_advanced", className: "btn btn-outline-secondary btn-sm float-end", onClick: () => setAdvancedOpen((o) => !o) }, I18nextManager.getInstance().i18n.t('visyn:permission.advanced')),
        extra,
        React.createElement("div", { className: advancedOpen ? 'd-block' : 'd-none' },
            React.createElement("div", { className: "tdp-permissions-entry row d-flex align-items-center mt-1" },
                React.createElement("label", { className: "form-label col-sm-auto ps-2" }, I18nextManager.getInstance().i18n.t('visyn:permission.public')),
                React.createElement("span", null),
                React.createElement(PermissionsEntry, { permission: permission, setPermission: setPermission, setGetter: (p) => p.others })),
            React.createElement("p", { className: "form-text" }, I18nextManager.getInstance().i18n.t('visyn:permission.definePermissions')),
            React.createElement("div", { className: "tdp-permissions-entry row d-flex align-items-center mt-1" },
                React.createElement("label", { className: "form-label col-sm-auto ps-2", htmlFor: `permission_group_name_${id}` }, I18nextManager.getInstance().i18n.t('visyn:permission.group')),
            ...
            React.createElement("p", { className: "form-text" }, I18nextManager.getInstance().i18n.t('visyn:permission.specifyRole')),
            React.createElement("div", { className: "tdp-permissions-entry row d-flex align-items-center mt-1" },
                React.createElement("label", { className: "form-label col-sm-auto ps-2", htmlFor: `permission_buddies_name_${id}` }, I18nextManager.getInstance().i18n.t('visyn:permission.buddies')),
                React.createElement("input", { id: `permission_buddies_name_${id}`, name: "permission_buddies_name", className: "form-control form-control-sm", placeholder: I18nextManager.getInstance().i18n.t('visyn:permission.buddiesPlaceholder'), value: buddies.join(';'), onChange: (e) => setBuddies(e.currentTarget.value.split(';')) }),
                React.createElement(PermissionsEntry, { permission: permission, setPermission: setPermission, setGetter: (p) => p.buddies })),
            React.createElement("p", { className: "form-text" }, I18nextManager.getInstance().i18n.t('visyn:permission.buddiesDescription')))));
}
