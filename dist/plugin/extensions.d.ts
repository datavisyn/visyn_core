...
export declare const EP_PHOVEA_CORE_LOGIN = "epPhoveaCoreLogin";
export declare const EP_PHOVEA_CORE_LOGOUT = "epPhoveaCoreLogout";
export declare const EP_PHOVEA_CORE_LOCALE = "epPhoveaCoreLocale";
