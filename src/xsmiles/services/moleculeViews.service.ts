import type { Props as MoleculeViewProps } from '../components/molecule/MoleculeViews';
...
class MoleculeViewsService {
  ...
  public getConfigBasedOnPropsAndMethod = (props: MoleculeViewProps): MoleculeViewsConfig => {
    ...
    let { alphaRange = theme === 'light' ? defaultLightAlphaRange : defaultDarkAlphaRange } = props;
