    ...
    <VisProvider>
      {disableMantine6 ? (
        <React.Suspense fallback={null}>
          <LazyMantineProvider {...(mergedMantineProviderProps as MantineProviderProps)}>
        ...
        <React.Suspense fallback={null}>
          <LazyMantine6Provider {...(mergedMantineProviderProps as Mantine6ProviderProps)}>
