...
import LineUp, { builder, buildRanking, Taggle, Ranking, DataBuilder, LocalDataProvider, EngineRenderer, TaggleRenderer } from 'lineupjs';
...
export function VisynRanking<T extends Record<string, unknown>>({
  data,
