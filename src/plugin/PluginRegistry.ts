...
export class PluginRegistry implements IRegistry {
  ...
  public push(type: string, idOrLoader: string | (() => any), descOrLoader: any, desc?: any) {
    const id = typeof idOrLoader === 'string' ? <string>idOrLoader : uniqueId(type);
   ...
   * @returns {IPluginDesc}
   */
  public getPlugin(type: 'visynView', id: string): VisynViewPluginDesc | undefined;
  public getPlugin(type: string, id: string): IPluginDesc | undefined;
  public getPlugin(type: string, id: string): IPluginDesc | undefined {
