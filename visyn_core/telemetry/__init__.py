...
def init_telemetry(app: FastAPI, app_name: str) -> None:
    ...
    metrics_enabled = manager.settings.visyn_core.telemetry.metrics.enabled
    metrics_export_endpoint = manager.settings.visyn_core.telemetry.metrics.export_endpoint
    traces_enabled = manager.settings.visyn_core.telemetry.traces.enabled
    traces_export_endpoint = manager.settings.visyn_core.telemetry.traces.export_endpoint
    timeout = 1
    ...
    logs_settings = manager.settings.visyn_core.telemetry.logs
    ...
    if manager.settings.visyn_core.telemetry.metrics_middleware.enabled:
