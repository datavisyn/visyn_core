...
class DBMigrationManager:
    ...
    - autoUpgrade: Flag which auto-upgrades to the latest revision (passed to DBManager). Defaults to config key 'visyn_core.migrations.autoUpgrade', or True if not configured.
